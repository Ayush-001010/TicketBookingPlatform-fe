...
export default class RailwayDetailsConfig {
    static stateFooterConfig: Array<{ displayName: string, type: "button", navLink?: string }> = [{ displayName: "View Stations", type: "button", navLink: "/RailwayDetails/" }];
    static stationFooterConfig: Array<{ displayName: string, type: "button", buttonType?: "delete", navLink?: string }> = [{ displayName: "Edit", type: "button" } , {displayName : "View Trains" , type : "button"}];
