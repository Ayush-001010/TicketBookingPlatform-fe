        ...
        <div >
          ...
          <div className={styles.css3}>
            ...
            <div className={styles.css4}>
              ...
              <p className={styles.css2}>{data?.TypeOfCoach.map( (item:string , index : number) => `${item}${index === data.TypeOfCoach.length - 1 ? "" : ","}`)}</p>
            </div>
          </div>
          <div className={styles.css3}>
            <div className={styles.css4}>
            ...
            <div className={styles.css4}>
              ...
              <p className={styles.css2}>{data?.RunningDay.map( (item:string  , index : number) => `${item}${index === data.RunningDay.length - 1 ? "" : ","}`)}</p>
            </div>
          </div>
        </div>
      );
